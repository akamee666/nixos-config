...
in {
  ...
  # Theme, if available
  xdg.configFile."waybar/theme.css".source = ./${theme}/theme.css;

  # Testing config
  xdg.configFile."waybar/config".source = ./${theme}/config;

  xdg.configFile."waybar/volume_menu.xml".source = ./${theme}/volume_menu.xml;
}
